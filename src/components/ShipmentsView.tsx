                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-205 p-2.5 outline-none focus:border-blue-500 dark:border-slate-800 dark:bg-slate-805 font-mono font-bold text-blue-600 dark:text-blue-400 whitespace-nowrap"
                    />
                    {editingShipment === null && (
